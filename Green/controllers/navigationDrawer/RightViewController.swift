...
extension RightViewController {
    ...
    fileprivate func handleRootButton() {
        ...
        (navigationDrawerController?.rootViewController as? ToolbarController)?.transition(to: UIStoryboard.initialViewController(for: .main), completion: closeNavigationDrawer)
    }
